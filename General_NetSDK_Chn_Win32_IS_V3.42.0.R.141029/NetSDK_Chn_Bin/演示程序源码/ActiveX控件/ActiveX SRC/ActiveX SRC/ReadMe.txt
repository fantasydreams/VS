========================================================================
		ActiveX Control DLL : REALPLAYX
========================================================================

ControlWizard has created this project for your REALPLAYX ActiveX Control
...
that make up your REALPLAYX ActiveX Control DLL.
...
RealPlayXCtl.h
	This file contains the declaration of the CRealPlayXCtrl C++ class.

RealPlayXCtl.cpp
	This file contains the implementation of the CRealPlayXCtrl C++ class.

RealPlayXPpg.h
	This file contains the declaration of the CRealPlayXPropPage C++ class.

RealPlayXPpg.cpp
	This file contains the implementation of the CRealPlayXPropPage C++ class.

RealPlayXCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CRealPlayXCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file RealPlayX.rc.
