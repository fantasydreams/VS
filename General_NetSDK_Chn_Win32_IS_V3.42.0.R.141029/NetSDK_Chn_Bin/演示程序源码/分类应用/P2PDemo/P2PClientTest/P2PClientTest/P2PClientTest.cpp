...
int _tmain(int argc, char*argv[])
{
	...
	/************************************************************************/
	/*Init NetSDK、login Dahua device                                       */
	/************************************************************************/
	...
	int nPort = local_port;	// P2P: 127.0.0.1,Localport as a Dahua device
	int nSpecCap = 19;		// nSpecCap = 19为web私网穿透登陆方式
	char szName[16] = {"admin"};
	char szPWD[16] = {"admin"};	// Dahua Device username,password
	...
	/************************************************************************/
	/*Use as normal Dahua device,eg:Real play								*/
	/************************************************************************/
	else
	{
	...
	scanf("%d", &devicePort);
	/************************************************************************/
	/* Logout Dahua Device、clean up SDK                                    */
	/************************************************************************/
